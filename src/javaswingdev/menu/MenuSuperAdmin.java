...
public class MenuSuperAdmin extends JPanel {
    ...
    private void init() {
        ...
        add(scroll);
        addTitle("MENU SUPER ADMIN");
        addMenuItem(new ModelMenuItem(GoogleMaterialDesignIcon.DASHBOARD, "Dashboard"));
        addTitle("MANAGEMENT");
        addMenuItem(new ModelMenuItem(GoogleMaterialDesignIcon.ARCHIVE, "Stock Opname", "Barang Masuk", "Barang Keluar"));
        addMenuItem(new ModelMenuItem(GoogleMaterialDesignIcon.BUSINESS_CENTER, "MOU", "Surat Pesanan", "Surat Pengiriman"));
        addTitle("KONFIRMASI");
        addMenuItem(new ModelMenuItem(GoogleMaterialDesignIcon.VERIFIED_USER, "Validasi", "Barang Masuk", "Pengguna Baru"));
        addMenuItem(new ModelMenuItem(GoogleMaterialDesignIcon.PRINT, "Cetak Riwayat", "Barang Masuk", "Barang Keluar"));
        addTitle("LOGOUT");
        addMenuItem(new ModelMenuItem(GoogleMaterialDesignIcon.CLOUD_OFF, "Logout"));
    }
