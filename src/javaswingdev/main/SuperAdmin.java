...
import javaswingdev.formSuperAdmin.formBK_Cash;
import javaswingdev.formSuperAdmin.formBarangMasuk;
import javaswingdev.formSuperAdmin.formCetakRiwayatBK;
import javaswingdev.formSuperAdmin.formCetakRiwayatBM;
import javaswingdev.formSuperAdmin.formDataBarang;
import javaswingdev.formSuperAdmin.formMOU_Pengiriman;
import javaswingdev.formSuperAdmin.formMOU_Pesanan;
import javaswingdev.formSuperAdmin.formV_BarangMasuk;
import javaswingdev.formSuperAdmin.formV_PenggunaBaru;
...
public class SuperAdmin extends javax.swing.JFrame {
    ...
    private static SuperAdmin main;
    ...
    private void init() {
        ...
        menu.addEvent(new EventMenuSelected() {
            ...
            if (index == 0 ) {
                ...
                if (subindex == 1) {
                    showForm(new formV_BarangMasuk());
                } else if (subindex == 2){
                    showForm(new formV_PenggunaBaru());
                }
            } else if (index == 4) {
                if (subindex == 1) {
                ...
                if (returnValue == JOptionPane.YES_OPTION){
                    ...
                    SuperAdmin.this.dispose();
                }
                else if (returnValue == JOptionPane.NO_OPTION){
                    SuperAdmin.this.setVisible(true);
                }
            } 
        }
        });
    ...
    public static SuperAdmin getMain() {
        return main;
    }
    ...
    private void initComponents() {
        ...
        menu = new javaswingdev.menu.MenuSuperAdmin();
    ...
    private javaswingdev.menu.MenuSuperAdmin menu;
